      ...
      <div className="container mx-auto px-6 mt-16">
        ...
        >
          ...
          <div className="bg-white/50 dark:bg-gray-900/30 rounded-xl p-4 md:p-6 shadow-lg border-2 border-indigo-100 dark:border-indigo-900/50 relative mb-12">
            ...
            {/* Bottom section: About project and Technologies */}
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-4">
              {/* Project description */}
              <motion.div
                className="bg-white dark:bg-gray-800/90 p-6 rounded-lg shadow-md relative border-2 border-indigo-200 dark:border-indigo-800"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                transition={{ delay: 0.3 }}
              >
